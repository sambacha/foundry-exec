...
worker_threads_1.parentPort.on(`message`, async (data) => {
    ...
    const zipFs = new fslib_1.ZipFS(tmpFile, { create: true, libzip: await (0, libzip_1.getLibzipPromise)(), level: compressionLevel, stats: fslib_1.statUtils.makeDefaultStats() });
